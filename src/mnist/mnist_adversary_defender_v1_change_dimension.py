...
W_conv1 = weight_variable([5, 5, 1, output_dimention])
b_conv1 = bias_variable([output_dimention])
...
W_conv2 = weight_variable([5, 5, output_dimention, 64])
...
n_input_attack = 14*14*output_dimention

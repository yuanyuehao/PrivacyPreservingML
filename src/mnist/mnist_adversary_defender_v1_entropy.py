# This code use 3 layer convolutional model and ourput result
# of first layer as input to attacker, it compares entropy of 
# x and z fot evaluation
...
# z_entropy = (-h_pool1_flat*np.log2(h_pool1_flat)).sum(axis=1)

...
# of first layer as input to attacker, it doesn't update attacker
...
# optimizer_attacker = tf.train.AdamOptimizer(learning_rate=learning_rate).minimize(cost_attacker, var_list=[weight_attack, bias_attack])
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            ...
            c_attacker = sess.run(cost_attacker, feed_dict={x: batch_x, x_attack: batch_x})

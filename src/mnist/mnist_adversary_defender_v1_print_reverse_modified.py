# This code use 3 layer convolutional model and output result
# of first layer as input to attacker, it modifies learning rate 
# of defender
...
n_input_attack = 14*14*32 # MNIST data input (img shape: 28*28)
...
# Construct model
# Specify layer1 as the input of attackers model
x_ = multilayer_perceptron(h_pool1_flat, weights, biases)
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        index = 5 # the index of output image, range between 0..(batch_size-1)
        ...
        for i in range(total_batch):
            ...
            if i == total_batch - 1: 
              ...
              # print_img(image_restored[index], image_restored[index-1], 'validation_' + str(epoch))
